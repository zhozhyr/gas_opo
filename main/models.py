...
class Certificate(models.Model):
    ...
    scan = models.BinaryField(null=True, verbose_name="Scan")
...
class TU(models.Model):
    registr_nomer_oborudovaniya_tu = models.CharField(max_length=200, null=True)
    seriyniy_nomer_tu = models.CharField(max_length=200, null=True)
    gos_registracionniy_nomer = models.CharField(max_length=200, null=True)
    zavodskoy_nomer = models.CharField(max_length=200, null=True)
    marka_tu = models.CharField(max_length=500, null=True)
    kratkie_tehn_haract_tu = models.CharField(max_length=200, null=True)
    registr_nomer_gtt = models.CharField(max_length=200, null=True)
    nomer_tu_po_tehn_sheme = models.CharField(max_length=200, null=True)
    god_izgotovleniya = models.CharField(max_length=200, null=True)
    norm_srok_ekspluat_let = models.SmallIntegerField(null=True)
    god_vvoda_v_ekspluat = models.SmallIntegerField(null=True)
    god_okonchaniya_ekspluat = models.SmallIntegerField(null=True)
    procent_iznosa = models.FloatField(null=True)
    data_posl_epb = models.DateField(null=True)
    data_sled_epb = models.DateField(null=True)
    data_ocherednoy_proverki = models.DateField(null=True)
    data_sled_proverki = models.DateField(null=True)
    razresh_srok_ekspluat = models.SmallIntegerField(null=True)
    nalichie_predohr_ustroystva = models.IntegerField(null=True)
    tip_predohr_ustr = models.CharField(max_length=200, null=True)
    obyom_m3 = models.FloatField(null=True)
    object_davlenie_mpa = models.FloatField(null=True)
    dy_mm = models.FloatField(null=True)
    tip = models.CharField(max_length=200, null=True)
    podtip = models.CharField(max_length=200, null=True)
    gruzopodyomnost_t = models.FloatField(null=True)
    obyom_t = models.FloatField(null=True)
    oborudovanie_davlenie_mpa = models.FloatField(null=True)
    god_modernizacii = models.SmallIntegerField(null=True)
    provedennie_meropriyatiya = models.CharField(max_length=200, null=True)
    nomer_razresheniya_rtn = models.CharField(max_length=200, null=True)
    nomer_zaklyucheniya_epb = models.CharField(max_length=200, null=True)
    nalichie_pasporta_tu = models.IntegerField(null=True)
    inf_tu_svedeniya_opo = models.CharField(max_length=200, null=True)
    inf_tu_rtn = models.CharField(max_length=200, null=True)
    nalichie_sertificata_sootvetstviya = models.IntegerField(null=True)
    nalichie_sertificata_rtn = models.IntegerField(null=True)
    primechanie = models.TextField(null=True)
    id_opo = models.BigIntegerField()
    id_classa_opasnosti = models.BigIntegerField(null=True)
    id_zavod_izgotovitel = models.BigIntegerField(null=True)
    id_vid_tu = models.BigIntegerField()
    id_tip_tu = models.BigIntegerField(null=True)
...
class Report_view(models.Model):
    ...
    id_opo = models.IntegerField(primary_key=True)  # Assuming 'id_opo' is unique and can be used as a primary key
    ...
    cb_onControl = models.CharField(max_length=255)
